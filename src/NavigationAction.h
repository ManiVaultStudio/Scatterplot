...
public:
    ...
    /**
     * Initialize the navigation action with pointer to owning \p scatterplotWidget
     * @param scatterplotWidget Pointer to scatterplot widget
     */
    void initialize(ScatterplotWidget* scatterplotWidget);
